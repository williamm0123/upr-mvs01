...
# =============================================================================
# arm R32_base_s1   —— 第二轮 (bf16 + 30k LR horizon)
#
# 第二轮新基线。bf16 + 30k horizon 都改变训练轨迹, 所以必须有新基线,
# 不能只跑 range 改动然后跟第一轮的数比。
#
#     sbatch scripts/arm_R32_base_s1.sh
#
...
#
# 单卡 A100, 12000 步, 约 3 小时。结果写 log/experiments/R32_base_s1/。
