...
# =============================================================================
# arm R32_f15   —— 第二轮 (bf16 + 30k LR horizon)
#
# stage4 窗宽下限 0.15 (floor 2.45mm, +107%)。回答继续加宽还有没有收益,
# 和 f10 一起给出交换曲线的第二个点。
#
#     sbatch scripts/arm_R32_f15.sh
#
...
#
# 单卡 A100, 12000 步, 约 3 小时。结果写 log/experiments/R32_f15/。
