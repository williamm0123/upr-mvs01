...
# =============================================================================
# arm R32_base_s2   —— 第二轮 (bf16 + 30k LR horizon)
#
# 新基线的第二个种子。所有判读阈值都建立在噪声估计上, 而现有的
# 0.048mm 是旧设置量的。overall / q3 / tail_frac 各自的地板都要重新量 ——
# 0.15mm 的 overall 阈值不能直接套给 q3。
#
#     sbatch scripts/arm_R32_base_s2.sh
#
...
#
# 单卡 A100, 12000 步, 约 3 小时。结果写 log/experiments/R32_base_s2/。
